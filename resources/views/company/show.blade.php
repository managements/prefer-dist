...
@section('content')
    <div class="content container-fluid">
        <div class="row">
            <div class="col-xs-7">
                <h4 class="page-title">{{ __('company') }}</h4>
            </div>
            @can('delete', $company)
                            ...
                            <div class="row">
                                <div class="col-md-5">
                                    <div class="profile-info-left">
                                        ...
                                        <div class="staff-id">{{ __('validation.attributes.licence') }} : {{ $company->licence }}</div>
                                    </div>
                                </div>
                                <div class="col-md-7">
                                    <h4>{{ __('contact') }} :</h4>
            ...
            <div class="col-md-3">
                <div class="panel">
                    <div class="panel-body">
                        <h6 class="panel-title m-b-15">{{ __('validation.attributes.technical') }} :</h6>
                        <table class="table table-striped table-border">
                            ...
                            <tr>
                                <td>{{ __('validation.attributes.limit') }} :</td>
